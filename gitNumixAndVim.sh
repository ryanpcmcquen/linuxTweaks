...
sudo wget https://github.com/ryanpcmcquen/numix-icon-theme-shine/archive/master.zip -P ~/;
...
sudo rm -rf /usr/share/icons/numix-icon-theme-shine-master/; sudo rm ~/master.zip;

sudo wget https://github.com/shimmerproject/Numix/archive/master.zip -P ~/;
sudo unzip ~/master.zip -df /usr/share/themes/; sudo rm ~/master.zip;
