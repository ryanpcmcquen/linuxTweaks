...
sudo apt-get install build-essential linux-generic git git-core curl htop vim gksu dos2unix ruby ruby-dev rubygems python-dev python-setuptools python-pip python-apt dkms gftp mc
