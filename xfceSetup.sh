...
xfconf-query -n -c xfce4-keyboard-shortcuts -p "/commands/custom/<Primary><Shift>_" -t string -s "amixer set Master 5%- unmute && amixer set -c 1 Master 5%- unmute"
xfconf-query -n -c xfce4-keyboard-shortcuts -p "/commands/custom/<Primary><Shift>+" -t string -s "amixer set Master 5%+ unmute && amixer set -c 1 Master 5%+ unmute"
